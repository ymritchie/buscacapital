...
public class Mensagens {
	...
	public static String getMensagem(String msg, String... argumentos) {
		...
		for (Integer x = 0; x < argumentos.length; x++) {
			...
			if (msgParam == msg) {
				throw new BuscaCapitalException("Problema na Mensagem!");
			} else {
				msg = msgParam;
			}
		}
	 ...
	 *             o erro.
	 */
	public static void addMessage(String msg, String... argumentos)  {
	 ...
	 * @param mensagem
	 */
	public static void addMsgInfo(String titulo, String mensagem) {
